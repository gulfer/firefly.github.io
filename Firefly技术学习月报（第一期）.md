...
[应用数据采集](http://blog.csdn.net/qq309909897/article/details/52512926) @huwenan
...
[React组件之间的通信](https://github.com/gingermount/gingermount.github.io/blob/master/react%E7%BB%84%E4%BB%B6%E9%80%9A%E4%BF%A1.md) @jiangshan

React在数据流向性上的一大特点就是他的单向性，这个特点使得组件之间的通信会有一些麻烦。本文主要分三种情况介绍react组件的通信。从最基本的父子之间进行通信（即父组件传递数值到子组件，和子组件传递到父组件），到拥有同一父节点的兄弟组件之间的通信，以及没有任何层级关系的两个组件互相之间的通信。
